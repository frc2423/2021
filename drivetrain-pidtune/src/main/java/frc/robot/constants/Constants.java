...
public class Constants {
    ...
    public static double REAL_DRIVE_KP = 0.08;
    public static double REAL_DRIVE_KI = 0.001;
    public static double REAL_DRIVE_KD = 0.1;
    public static double REAL_DRIVE_KF = 0.07;
}
