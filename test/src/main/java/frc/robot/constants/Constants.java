...
public class Constants {
    ...
    public static double SIM_DRIVE_KP = 0;
    public static double SIM_DRIVE_KI = 0;
    public static double SIM_DRIVE_KD = 0;
    public static double SIM_DRIVE_KF = 0;
    public static double REAL_DRIVE_KP = 0;
    public static double REAL_DRIVE_KI = 0;
    public static double REAL_DRIVE_KD = 0;
    public static double REAL_DRIVE_KF = 0;
}
